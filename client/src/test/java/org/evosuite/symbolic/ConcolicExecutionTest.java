...
public class ConcolicExecutionTest {
	...
	private DefaultTestCase buildTestCase0() throws SecurityException, NoSuchMethodException {
	...
	//
	private DefaultTestCase buildTestCase10() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference double0 = tc.appendDoublePrimitive(-2020.5367255717083);
		VariableReference double1 = tc.appendDoublePrimitive(698.931685369782);
		VariableReference double3 = tc.appendDoublePrimitive(1.8078644807328579);
		VariableReference double4 = tc.appendDoublePrimitive(1756.567093813958);
		Method method = TestCase10.class.getMethod("test", double.class, double.class, double.class, double.class);
	...
	private DefaultTestCase buildTestCase11() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase11.class.getMethod("test", int.class, int.class, int.class, int.class);
	...
	private DefaultTestCase buildTestCase12() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase12.class.getMethod("test", long.class, long.class, long.class, long.class);
	...
	private DefaultTestCase buildTestCase13() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference double0 = tc.appendDoublePrimitive(TestCase13.DOUBLE_VALUE);
	...
	private DefaultTestCase buildTestCase14() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference double1 = tc.appendDoublePrimitive(TestCase14.DOUBLE_VALUE);
	...
	private DefaultTestCase buildTestCase15() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference double1 = tc.appendDoublePrimitive(TestCase15.DOUBLE_CONSTANT);
	...
	private DefaultTestCase buildTestCase16() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase16.class.getMethod("test", int.class, int.class, long.class, long.class, float.class,
				float.class, double.class, double.class);
		tc.appendMethod(null, method, int0, int1, long0, long1, float0, float1, double0, double1);
		return tc.getDefaultTestCase();
	}
	...
	// double double0 = ConcolicMarker.mark(DOUBLE_VALUE, "double0");
	private DefaultTestCase buildTestCase17() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference float0 = tc.appendFloatPrimitive(TestCase17.FLOAT_VALUE);
		VariableReference double0 = tc.appendDoublePrimitive(TestCase17.DOUBLE_VALUE);

		Method method = TestCase17.class.getMethod("test", float.class, double.class);
	...
	private DefaultTestCase buildTestCase18() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference float0 = tc.appendFloatPrimitive(TestCase18.FLOAT_VALUE);
		VariableReference double0 = tc.appendDoublePrimitive(TestCase18.DOUBLE_VALUE);

		Method method = TestCase18.class.getMethod("test", float.class, double.class);
		tc.appendMethod(null, method, float0, double0);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase19() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference float0 = tc.appendFloatPrimitive(TestCase19.FLOAT_VALUE);
		VariableReference double0 = tc.appendDoublePrimitive(TestCase19.DOUBLE_VALUE);

		Method method = TestCase19.class.getMethod("test", float.class, double.class);
		tc.appendMethod(null, method, float0, double0);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase20() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference float0 = tc.appendFloatPrimitive(TestCase20.FLOAT_VALUE);
		VariableReference double0 = tc.appendDoublePrimitive(TestCase20.DOUBLE_VALUE);

		Method method = TestCase20.class.getMethod("test", float.class, double.class);
		tc.appendMethod(null, method, float0, double0);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase21() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference float0 = tc.appendFloatPrimitive(TestCase21.FLOAT_VALUE);
		VariableReference double0 = tc.appendDoublePrimitive(TestCase21.DOUBLE_VALUE);

		Method method = TestCase21.class.getMethod("test", float.class, double.class);
		tc.appendMethod(null, method, float0, double0);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase22() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference float0 = tc.appendFloatPrimitive(TestCase22.FLOAT_VALUE_1);
		VariableReference double0 = tc.appendDoublePrimitive(TestCase22.DOUBLE_VALUE_1);

		Method method = TestCase22.class.getMethod("test", float.class, double.class);
		tc.appendMethod(null, method, float0, double0);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase23() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive(TestCase23.STRING_VALUE);
	...
	private DefaultTestCase buildTestCase24() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive(TestCase24.STRING_VALUE);
	...
	private DefaultTestCase buildTestCase25() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive(TestCase25.STRING_VALUE);
	...
	private DefaultTestCase buildTestCase26() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive(TestCase26.STRING_VALUE_PART_1);
	...
	private DefaultTestCase buildTestCase27() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive(TestCase27.STRING_VALUE);
	...
	private DefaultTestCase buildTestCase28() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive(TestCase28.STRING_VALUE);
	...
	private DefaultTestCase buildTestCase29() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference boolean0 = tc.appendBooleanPrimitive(true);
		VariableReference boolean1 = tc.appendBooleanPrimitive(false);
		Method method = TestCase29.class.getMethod("test", boolean.class, boolean.class);
	...
	private DefaultTestCase buildTestCase30() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive(TestCase30.STRING_VALUE);
	...
	private DefaultTestCase buildTestCase31() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive(TestCase31.STRING_VALUE);
	...
	private DefaultTestCase buildTestCase32() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive(TestCase32.STRING_VALUE);
	...
	private DefaultTestCase buildTestCase33() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase34() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase35() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive(TestCase35.STRING_VALUE);
	...
	private DefaultTestCase buildTestCase36() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive(TestCase36.STRING_VALUE);
	...
	private DefaultTestCase buildTestCase37() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase3() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference int0 = tc.appendIntPrimitive(-1);
	...
	private DefaultTestCase buildTestCase38() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase38.class.getMethod("test", int.class, boolean.class, short.class, byte.class,
				char.class, long.class, float.class, double.class);
		tc.appendMethod(null, method, int0, boolean0, short0, byte0, char0, long0, float0, double0);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase39() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference int0 = tc.appendIntPrimitive(20);
		VariableReference string2 = tc.appendStringPrimitive(TestCase39.ROBA);

		Method method = TestCase39.class.getMethod("test", int.class, String.class);
	...
	private DefaultTestCase buildTestCase40() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference int0 = tc.appendIntPrimitive(10);
		VariableReference int1 = tc.appendIntPrimitive(1);
		VariableReference float0 = tc.appendFloatPrimitive(Float.POSITIVE_INFINITY);

		Method method = TestCase40.class.getMethod("test", int.class, int.class, float.class);
	...
	private DefaultTestCase buildTestCase41() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase41.class.getMethod("test", int.class, int.class, int.class, int.class);
	...
	private DefaultTestCase buildTestCase42() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase43() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference int0 = tc.appendIntPrimitive(Integer.MAX_VALUE);
	...
	private DefaultTestCase buildTestCase44() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase44.class.getMethod("test", int.class, int.class, int.class, int.class, int.class,
				int.class, int.class, int.class, int.class, int.class, int.class);
		tc.appendMethod(null, method, int0, int1, int2, int3, int4, int5, int6, int7, int8, int9, int10);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase45() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase46() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive("\\5b;\u001C,?\u0011\u0010\u001E]\"");
		VariableReference string1 = tc.appendStringPrimitive("\\5b;\u001C,?\u0011\u0010\u001E]\"");
		VariableReference string2 = tc.appendStringPrimitive("\\5b;\u001C,?\u0011\u0010\u001E]\"");
		VariableReference string3 = tc.appendStringPrimitive("\\5b;\u001C,?\u0011\u0010\u001E]\"");
		VariableReference string4 = tc.appendStringPrimitive("\\5b;\u001C,?\u0011\u0010\u001E]\"");
		VariableReference string5 = tc.appendStringPrimitive("\\5b;\u001C,?\u0011\u0010\u001E]\"");
		VariableReference string6 = tc.appendStringPrimitive("\\5b;\u001C,?\u0011\u0010\u001E]\"");
		VariableReference string7 = tc.appendStringPrimitive("\\5b;\u001C,?\u0011\u0010\u001E]\"");
		...
		VariableReference string20 = tc.appendStringPrimitive("urVf3T\r\t\u0019\u000B0 eiM I");
		VariableReference string21 = tc.appendStringPrimitive("urVf3T\r\t\u0019\u000B0 eiM I");
		VariableReference string22 = tc.appendStringPrimitive("urVf3T\r\t\u0019\u000B0 eiM I");
		VariableReference string23 = tc.appendStringPrimitive("ical");
		Method method = TestCase46.class.getMethod("test", String.class, String.class, String.class, String.class,
				String.class, String.class, String.class, String.class, String.class, String.class, String.class,
				String.class, String.class, String.class, String.class, String.class, String.class, String.class,
				String.class, String.class, String.class, String.class, String.class, String.class);

		tc.appendMethod(null, method, string0, string1, string2, string3, string4, string5, string6, string7, string8,
				string9, string10, string11, string12, string13, string14, string15, string16, string17, string18,
				string19, string20, string21, string22, string23);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase47() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase47.class.getMethod("test", char.class, char.class, char.class, char.class);
	...
	private DefaultTestCase buildTestCase48() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase48.class.getMethod("test", char.class, char.class, char.class, char.class, char.class,
				char.class, char.class, char.class, char.class);
		tc.appendMethod(null, method, char0, char1, char2, char3, char4, char5, char6, char7, char8);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase49() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase50() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase50.class.getMethod("test", char.class, char.class, char.class, char.class, char.class,
				char.class);
	...
	private DefaultTestCase buildTestCase52() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive("Togliere sta roba");
		VariableReference string1 = tc.appendStringPrimitive(" ");

		Method method = TestCase52.class.getMethod("test", String.class, String.class);
	...
	private DefaultTestCase buildTestCase2() throws SecurityException, NoSuchMethodException {
		...
		Method method = TestCase2.class.getMethod("test", int.class, int.class, int.class, int.class, int.class);
	...
	private DefaultTestCase buildTestCase4() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference long0 = tc.appendLongPrimitive(1554151784714561687L);
		VariableReference int0 = tc.appendIntPrimitive(0);

		Method method = TestCase4.class.getMethod("test", long.class, int.class);
	...
	private DefaultTestCase buildTestCase5() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase5.class.getMethod("test", float.class, float.class, float.class, float.class,
				float.class);
	...
	private DefaultTestCase buildTestCase56() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference int0 = tc.appendIntPrimitive(1515);
		VariableReference int2 = tc.appendIntPrimitive(1541);

		Method method = TestCase56.class.getMethod("test", int.class, int.class);
	...
	private DefaultTestCase buildTestCase57() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba".toUpperCase());
		VariableReference string3 = tc.appendStringPrimitive("Togliere");

		Method method = TestCase57.class.getMethod("test", String.class, String.class);
	...
	// String string1 = ConcolicMarker.mark("Togliere sta roba".toUpperCase(),
	// "string1");
	private DefaultTestCase buildTestCase58() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba".toUpperCase());
	...
	private DefaultTestCase buildTestCase59() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba");
		VariableReference int1 = tc.appendIntPrimitive(5);

		Method method = TestCase59.class.getMethod("test", String.class, int.class);
	...
	private DefaultTestCase buildTestCase6() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference float0 = tc.appendFloatPrimitive(1442.5817F);
		VariableReference float1 = tc.appendFloatPrimitive(1.0F);

		Method method = TestCase6.class.getMethod("test", float.class, float.class);
	...
	// String string1 = ConcolicMarker.mark(string0, "string1");
	private DefaultTestCase buildTestCase60() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba");
	...
	private DefaultTestCase buildTestCase61() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba");
	...
	private DefaultTestCase buildTestCase62() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba");
	...
	private DefaultTestCase buildTestCase63() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba");
	...
	private DefaultTestCase buildTestCase64() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba");
	...
	private DefaultTestCase buildTestCase65() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba");
	...
	private DefaultTestCase buildTestCase66() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba");
	...
	// String string1 = ConcolicMarker.mark(string0, "string0");
	private DefaultTestCase buildTestCase67() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba");
	...
	private DefaultTestCase buildTestCase68() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba");
	...
	private DefaultTestCase buildTestCase69() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	// float float0 = ConcolicMarker.mark(1442.5817F,"var1");
	// float float1 = ConcolicMarker.mark(1.0F,"var2");
	private DefaultTestCase buildTestCase7() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference long0 = tc.appendLongPrimitive(0L);
		VariableReference long1 = tc.appendLongPrimitive(0L);

		Method method = TestCase7.class.getMethod("test", long.class, long.class);
	...
	private DefaultTestCase buildTestCase72() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive("enci");
		VariableReference string9 = tc.appendStringPrimitive("nov");
		Method method = TestCase72.class.getMethod("test", String.class, String.class);
	...
	private DefaultTestCase buildTestCase73() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive("enci");
		VariableReference string1 = tc.appendStringPrimitive("c");
		Method method = TestCase73.class.getMethod("test", String.class, String.class);
		tc.appendMethod(null, method, string0, string1);
		return tc.getDefaultTestCase();
	}
	...
	// String string2 = ConcolicMarker.mark("roba ", "string2");
	private DefaultTestCase buildTestCase74() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase74.class.getMethod("test", String.class, String.class, String.class);
	...
	// String string1 = ConcolicMarker.mark("sta ", "string1");
	// String string2 = ConcolicMarker.mark("roba ", "string2");
	private DefaultTestCase buildTestCase75() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive("Togliere");
		VariableReference string1 = tc.appendStringPrimitive("sta");
		VariableReference string2 = tc.appendStringPrimitive("roba");
		Method method = TestCase75.class.getMethod("test", String.class, String.class, String.class);
		tc.appendMethod(null, method, string0, string1, string2);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase76() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference int0 = tc.appendIntPrimitive(10);
		VariableReference int1 = tc.appendIntPrimitive(0);
		VariableReference int2 = tc.appendIntPrimitive(-1);

		Method method = TestCase76.class.getMethod("test", int.class, int.class, int.class);
	...
	private DefaultTestCase buildTestCase77() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference int0 = tc.appendIntPrimitive(10);
		VariableReference int1 = tc.appendIntPrimitive(20);
		VariableReference int2 = tc.appendIntPrimitive(30);

		Method method = TestCase77.class.getMethod("test", int.class, int.class, int.class);
		tc.appendMethod(null, method, int0, int1, int2);
		return tc.getDefaultTestCase();
	}
	...
	// int int0 = ConcolicMarker.mark(10, "int0");
	private DefaultTestCase buildTestCase78() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference int0 = tc.appendIntPrimitive(10);
	...
	private DefaultTestCase buildTestCase79() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	// int int0 = ConcolicMarker.mark(-1,"var1");
	private DefaultTestCase buildTestCase8() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference int0 = tc.appendIntPrimitive(-1);
	...
	private DefaultTestCase buildTestCase80() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase81() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase82() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase82.class.getMethod("test", char.class, boolean.class, short.class, byte.class);
	...
	private DefaultTestCase buildTestCase83() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase83.class.getMethod("test", String.class, String.class, int.class);
	...
	private DefaultTestCase buildTestCase84() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase85() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference string0 = tc.appendStringPrimitive("aaaaaaaaaaab");
	...
	private DefaultTestCase buildTestCase9() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		VariableReference int0 = tc.appendIntPrimitive(0);
	...
	private DefaultTestCase buildTestCase71() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase71.class.getMethod("test", char.class, char.class, char.class, char.class, char.class,
				char.class, char.class, char.class, char.class);
		tc.appendMethod(null, method, char0, char1, char2, char3, char4, char5, char6, char7, char8);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase54() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
		...
		Method method = TestCase54.class.getMethod("test", int.class, int.class, int.class, char.class, char.class,
				char.class, char.class, char.class, char.class, char.class, char.class, char.class, char.class,
				char.class, char.class);
		tc.appendMethod(null, method, int0, int1, int2, char0, char1, char2, char3, char4, char5, char6, char7, char8,
				char9, char10, char11);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase87() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase88() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();

		VariableReference int0 = tc.appendIntPrimitive(10);
		VariableReference int1 = tc.appendIntPrimitive(20);

		Method method = TestCase88.class.getMethod("test", int.class, int.class);
		tc.appendMethod(null, method, int0, int1);
		return tc.getDefaultTestCase();
	}

	private DefaultTestCase buildTestCase89() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase90() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase91() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();

		VariableReference string0 = tc.appendStringPrimitive("135");
		VariableReference string1 = tc.appendStringPrimitive("20");
		VariableReference catchCount = tc.appendIntPrimitive(0);
		Method method = TestCase91.class.getMethod("test", String.class, String.class, int.class);
		tc.appendMethod(null, method, string0, string1, catchCount);
		return tc.getDefaultTestCase();
	}
	...
	private DefaultTestCase buildTestCase92() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();

		VariableReference string0 = tc.appendStringPrimitive("Togliere sta roba");
		VariableReference catchCount = tc.appendIntPrimitive(0);
		VariableReference boolean0 = tc.appendBooleanPrimitive(true);
		Method method = TestCase92.class.getMethod("test", String.class, int.class, boolean.class);
		tc.appendMethod(null, method, string0, catchCount, boolean0);
		return tc.getDefaultTestCase();
	}

	private DefaultTestCase buildTestCase93() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase94() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();

		VariableReference string0 = tc.appendStringPrimitive("Togliere sta roba");
		VariableReference string1 = tc.appendStringPrimitive("Togliere sta roba");
		Method method = TestCase94.class.getMethod("test", String.class, String.class);
		tc.appendMethod(null, method, string0, string1);

		return tc.getDefaultTestCase();
	}

	private DefaultTestCase buildTestCase95() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();

		VariableReference string0 = tc.appendStringPrimitive("Togliere_sta_roba");
		VariableReference string1 = tc.appendStringPrimitive("_");
		Method method = TestCase95.class.getMethod("test", String.class, String.class);
		tc.appendMethod(null, method, string0, string1);

		return tc.getDefaultTestCase();
	}

	private DefaultTestCase buildTestCase96() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();

		VariableReference string0 = tc.appendStringPrimitive("Toglieresta roba");
		VariableReference int0 = tc.appendIntPrimitive(0);
		Method method = TestCase96.class.getMethod("test", String.class, int.class);
		tc.appendMethod(null, method, string0, int0);

		return tc.getDefaultTestCase();
	}

	private DefaultTestCase buildTestCase97() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase98() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase99() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();
	...
	private DefaultTestCase buildTestCase100() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();

		Method method = TestCase100.class.getMethod("test", String.class, int.class);
	...
	private DefaultTestCase buildTestCase101() throws SecurityException, NoSuchMethodException {
		TestCaseBuilder tc = new TestCaseBuilder();

		Method method = TestCase101.class.getMethod("test", Class.class, String.class);

		VariableReference clazzPrimitive0 = tc.appendClassPrimitive(TestCase101.class);
		VariableReference string0 = tc.appendStringPrimitive(TestCase101.class.getName());
