...
public final class ArchiveUtils {
	...
	/**
	 * Checks whether a specific goal (i.e., a
	 * {@link org.evosuite.testcase.TestFitnessFunction} object) is of an enabled
	 * criterion. A criterion is considered enabled if and only if defined in
