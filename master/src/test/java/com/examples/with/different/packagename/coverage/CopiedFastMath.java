...
public class CopiedFastMath {
    ...
    public static double acosh(final double a) {
        return CopiedFastMath.log(a + CopiedFastMath.sqrt(a * a - 1));
    }
    ...
    public static double asinh(double a) {
        ...
        double absAsinh;
        if (a > 0.167) {
            absAsinh = CopiedFastMath.log(CopiedFastMath.sqrt(a * a + 1) + a);
        } else {
            final double a2 = a * a;
            if (a > 0.097) {
    ...
    public static double atanh(double a) {
        ...
        double absAtanh;
        if (a > 0.15) {
            absAtanh = 0.5 * CopiedFastMath.log((1 + a) / (1 - a));
        } else {
            final double a2 = a * a;
            if (a > 0.087) {
