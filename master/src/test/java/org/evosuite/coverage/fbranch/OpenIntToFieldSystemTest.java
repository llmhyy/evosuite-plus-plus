...
public class OpenIntToFieldSystemTest extends SystemTestBase {
...
//		suite.addTest(buildTestCase(3, Double.NEGATIVE_INFINITY));
	...
	private TestChromosome buildTestCase() throws ClassNotFoundException, NoSuchMethodException, SecurityException {
		TestCaseBuilder builder = new TestCaseBuilder();
		VariableReference x = builder.appendDoublePrimitive(2);
		VariableReference y = builder.appendDoublePrimitive(4);
