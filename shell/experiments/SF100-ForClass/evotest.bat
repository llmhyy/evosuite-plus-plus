...
SET TARGET_METHOD_FILE=!ROOT!/targetMethod_byType_primitive.txt
...
for /D %%I in (*_*) do (
	...
	SET OPTIONS=-inclusiveFile !TARGET_METHOD_FILE! -testLevel lClass -target !PROJECT!.jar -iteration 1 -Dsearch_budget 300 -Dinstrument_context true -Dp_test_delete 0 -Dp_test_change 0.9 -Dp_test_insert 0.1 -Dp_change_parameter 0.1 -Dlocal_search_rate 3 -Dp_functional_mocking 0 -Dmock_if_no_generator false -Dfunctional_mocking_percent 0 -Dprimitive_reuse_probability 0 -Dmin_initial_tests 10 -Dmax_initial_tests 20 -Ddse_probability 0 -Dinstrument_libraries true -Dinstrument_parent true -Dmax_attempts 100 -Dassertions false -Delite 10 -Ddynamic_pool 0.0 -Dlocal_search_ensure_double_execution false -generateMOSuite -Dstrategy MOSUITE -Dalgorithm MOSA
	
	SET exeCmd_BRANCH=%EVOTEST% -criterion branch !OPTIONS!
	
	SET exeCmd_FBRANCH=%EVOTEST% -criterion fbranch !OPTIONS!
