...
TARGET_METHOD_FILE=$ROOT/experimentSets/targetMethod_byType_uninterested_100.txt
for I in *_*; do
 ...
 CMD_BRANCH="$EVOTEST -criterion branch -reportFolder report-branch-uninterested $OPTIONS"
 CMD_FBRANCH="$EVOTEST -criterion fbranch -reportFolder report-fbranch-uninterested $OPTIONS"
