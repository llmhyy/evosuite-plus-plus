...
TARGET_METHOD_FILE=$ROOT/experimentSets/testProjects/targetMethod_byType_uninterested.txt
for I in *_*; do
 ...
 CMD_BRANCH="$EVOTEST -criterion branch -reportFolder report-branch-4prj-uninterested $OPTIONS"
 CMD_FBRANCH="$EVOTEST -criterion fbranch -reportFolder report-fbranch-4prj-uninterested $OPTIONS"
