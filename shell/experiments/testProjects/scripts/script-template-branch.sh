...
TARGET_METHOD_FILE=$ROOT/experimentSets/testProjects/${FILE_NAME}.txt
for I in *_*; do
 ...
 CMD_BRANCH="$EVOTEST -criterion branch -reportFolder report-branch${folder-subfix} $OPTIONS"
 CMD_FBRANCH="$EVOTEST -criterion fbranch -reportFolder report-fbranch${folder-subfix} $OPTIONS"
