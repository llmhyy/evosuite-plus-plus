...
public class MainMethodFilter extends MethodFlagCondFilter {
	public static final String excelProfileSubfix = "_mainMethodProfiles.xlsx";
	private static Logger log = LoggerUtils.getLogger(MainMethodFilter.class);
