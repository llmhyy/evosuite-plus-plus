...
FOLDER_NAME=graph-initial-monotonic-localsearch-evoobj
...
for I in *_*; do
 ...
 CMD_BRANCH="$EVOTEST -generateSuite -Dstrategy Evosuite -Dalgorithm MONOTONIC_GA -criterion branch $TEST_OPTIONS $OPTIONS -exclFinishedMethods" 
 CMD_FBRANCH="$EVOTEST -generateSuite -Dstrategy Evosuite -Dalgorithm MONOTONIC_GA -criterion fbranch $TEST_OPTIONS -branchExperimentFile $EXPERIMENT_BRANCH_FILE $OPTIONS -exclFinishedMethods"
