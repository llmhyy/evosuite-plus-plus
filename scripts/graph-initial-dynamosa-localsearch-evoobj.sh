...
FOLDER_NAME=graph-initial-dynamosa-localsearch-evoobj
...
for I in *_*; do
 ...
 CMD_BRANCH="$EVOTEST -generateMOSuite -Dstrategy MOSUITE -Dalgorithm DYNAMOSA -criterion branch $TEST_OPTIONS $OPTIONS -exclFinishedMethods" 
 CMD_FBRANCH="$EVOTEST -generateMOSuite -Dstrategy MOSUITE -Dalgorithm DYNAMOSA -criterion fbranch $TEST_OPTIONS -branchExperimentFile $EXPERIMENT_BRANCH_FILE $OPTIONS -exclFinishedMethods"
