...
public class IterDistributionRecorder extends DistributionRecorder {
	...
	public IterDistributionRecorder() {
		super();
		iterdistributionExcelWriter = new ExcelWriter(FileUtils.newFile(Settings.getReportFolder(), projectId + "_distribution_stat.xlsx"));
		iterdistributionExcelWriter.getSheet("data", new String[] {"Class", "Method","averagedistance","time","coverage"}, 0);
	...
	public IterDistributionRecorder(String strategy) {
		super(strategy);
		iterdistributionExcelWriter = new ExcelWriter(FileUtils.newFile(Settings.getReportFolder(), projectId + "_" + strategy+"_distribution_stat.xlsx"));
		iterdistributionExcelWriter.getSheet("data", new String[] {"Class", "Method","averagedistance","time","coverage"}, 0);
		allresults = new ArrayList<TestGenerationResult>();
