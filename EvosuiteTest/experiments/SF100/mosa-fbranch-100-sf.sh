...
TARGET_METHOD_FILE=$ROOT/target-method-100-sf.txt
for I in *_*; do
 ...
 CMD_BRANCH="$EVOTEST -generateMOSuite -Dstrategy MOSUITE -Dalgorithm MOSA -criterion branch $OPTIONS"
 CMD_FBRANCH="$EVOTEST -generateMOSuite -Dstrategy MOSUITE -Dalgorithm MOSA -criterion fbranch $OPTIONS"
