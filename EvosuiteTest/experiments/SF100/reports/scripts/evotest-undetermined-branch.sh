...
for I in *_*; do
 ...
 CMD_BRANCH="$EVOTEST -criterion branch -reportFolder report-branch-undetermined $OPTIONS"
 CMD_FBRANCH="$EVOTEST -criterion fbranch -reportFolder report-fbranch-undetermined $OPTIONS"
