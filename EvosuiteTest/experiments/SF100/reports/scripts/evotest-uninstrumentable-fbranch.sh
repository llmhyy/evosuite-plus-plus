...
TARGET_METHOD_FILE=$ROOT/experimentSets/targetMethod_byType_uninstrumentable_100.txt
for I in *_*; do
 ...
 CMD_BRANCH="$EVOTEST -criterion branch -reportFolder report-branch-uninstrumentable $OPTIONS"
 CMD_FBRANCH="$EVOTEST -criterion fbranch -reportFolder report-fbranch-uninstrumentable $OPTIONS"
