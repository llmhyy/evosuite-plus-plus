...
public class ValueServerTest extends AbstractETest{
	
	@Test
	public void test() {
		Class<?> clazz = org.apache.commons.math.random.ValueServer.class;
		String methodName = "getNextReplay";
		int parameterNum = 0;
...
//		Properties.TIMELINE_INTERVAL = 3000;
		...
		int timeBudget = 200;
		ValueServerTest t = new ValueServerTest();
