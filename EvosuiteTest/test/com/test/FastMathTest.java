...
//		Properties.TIMELINE_INTERVAL = 3000;
		...
		List<EvoTestResult> l1 = runRepetativeTimes(targetClass, targetMethod, cp, timeBudget, fitnessApproach);
		
		fitnessApproach = "branch";
		List<EvoTestResult> l2 = runRepetativeTimes(targetClass, targetMethod, cp, timeBudget, fitnessApproach);
	...
	private List<EvoTestResult> runRepetativeTimes(String targetClass, String targetMethod, String cp, int timeBudget, String fitnessApproach) {
