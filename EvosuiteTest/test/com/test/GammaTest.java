...
public class GammaTest extends AbstractETest{
	
	@Test
	public void test() {
		Class<?> clazz = org.apache.commons.math.special.Gamma.class;
		String methodName = "regularizedGammaP";
		int parameterNum = 4;
